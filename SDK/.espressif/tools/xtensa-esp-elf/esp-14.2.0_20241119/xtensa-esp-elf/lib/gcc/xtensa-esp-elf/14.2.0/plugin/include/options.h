...
enum opt_code
{
  ...
  OPT_list = 1954,                           /* -list */
  OPT_mabi_call0 = 1955,                     /* -mabi=call0 */
  OPT_mabi_windowed = 1956,                  /* -mabi=windowed */
  OPT_malways_memw = 1957,                   /* -malways-memw */
  OPT_mauto_litpools = 1958,                 /* -mauto-litpools */
  OPT_mconst16 = 1959,                       /* -mconst16 */
  OPT_mdisable_hardware_atomics = 1960,      /* -mdisable-hardware-atomics */
  OPT_mdynconfig_ = 1961,                    /* -mdynconfig= */
  OPT_mextra_l32r_costs_ = 1962,             /* -mextra-l32r-costs= */
  OPT_mfix_esp32_psram_cache_issue = 1963,   /* -mfix-esp32-psram-cache-issue */
  OPT_mfix_esp32_psram_cache_strategy_ = 1964,/* -mfix-esp32-psram-cache-strategy= */
  OPT_mforce_no_pic = 1965,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1966, */              /* -mfused-madd */
  OPT_mlongcalls = 1967,                     /* -mlongcalls */
  /* OPT_mlra = 1968, */                     /* -mlra */
  OPT_mserialize_volatile = 1969,            /* -mserialize-volatile */
  OPT_mstrict_align = 1970,                  /* -mstrict-align */
  OPT_mtarget_align = 1971,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1972,         /* -mtext-section-literals */
  OPT_n = 1973,                              /* -n */
  ...
  OPT_r = 2009,                              /* -r */
  OPT_rdynamic = 2010,                       /* -rdynamic */
  OPT_remap = 2011,                          /* -remap */
  OPT_reverse_sort = 2012,                   /* -reverse-sort */
  OPT_s = 2013,                              /* -s */
  OPT_save_temps = 2014,                     /* -save-temps */
  OPT_save_temps_ = 2015,                    /* -save-temps= */
  OPT_shared = 2016,                         /* -shared */
  OPT_shared_libgcc = 2017,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2018,               /* -shared-libphobos */
  OPT_size_sort = 2019,                      /* -size-sort */
  /* OPT_specs = 2020, */                    /* -specs */
  OPT_specs_ = 2021,                         /* -specs= */
  OPT_static = 2022,                         /* -static */
  OPT_static_libasan = 2023,                 /* -static-libasan */
  OPT_static_libgcc = 2024,                  /* -static-libgcc */
  OPT_static_libgfortran = 2025,             /* -static-libgfortran */
  OPT_static_libgm2 = 2026,                  /* -static-libgm2 */
  ...
  OPT_static_libquadmath = 2033,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2034,               /* -static-libstdc++ */
  OPT_static_libtsan = 2035,                 /* -static-libtsan */
  OPT_static_libubsan = 2036,                /* -static-libubsan */
  OPT_static_pie = 2037,                     /* -static-pie */
  /* OPT_std_c__03 = 2038, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2039, */                /* -std=c++0x */
  OPT_std_c__11 = 2040,                      /* -std=c++11 */
  OPT_std_c__14 = 2041,                      /* -std=c++14 */
  OPT_std_c__17 = 2042,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2043, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2044, */                /* -std=c++1z */
  OPT_std_c__20 = 2045,                      /* -std=c++20 */
  OPT_std_c__23 = 2046,                      /* -std=c++23 */
  OPT_std_c__26 = 2047,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2048, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2049, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2050, */                /* -std=c++2c */
  OPT_std_c__98 = 2051,                      /* -std=c++98 */
  OPT_std_c11 = 2052,                        /* -std=c11 */
  OPT_std_c17 = 2053,                        /* -std=c17 */
  /* OPT_std_c18 = 2054, */                  /* -std=c18 */
  /* OPT_std_c1x = 2055, */                  /* -std=c1x */
  OPT_std_c23 = 2056,                        /* -std=c23 */
  ...
  /* OPT_std_iso9899_2024 = 2100, */         /* -std=iso9899:2024 */
