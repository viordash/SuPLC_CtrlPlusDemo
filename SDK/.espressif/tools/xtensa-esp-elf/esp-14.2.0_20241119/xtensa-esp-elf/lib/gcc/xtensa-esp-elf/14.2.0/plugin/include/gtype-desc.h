...
#define gt_ggc_m_17hash_map_rtx_int_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_map_rtx_int_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_map_rtx_int_ (void *);
...
#define gt_pch_n_17hash_map_rtx_int_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_map_rtx_int_ (X);\
  } while (0)
extern void gt_pch_nx_hash_map_rtx_int_ (void *);
...
extern void gt_pch_p_42hash_table_omp_declare_variant_alt_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_17hash_map_rtx_int_
    (void *, void *, gt_pointer_operator, void *);
