...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--template', type=str, help='Template filename', default='template.c1')
    main(parser.parse_args(sys.argv[1:]))


# python /home/viordash/projects/SuPLC/linux_app/main/Display/fonts/tools/create_font.py -f "/usr/share/fonts/X11/misc/clR5x8.pcf.gz" -n "X11Misc" -c="ISO8859-1" -ttf=1 --first=32 --last=127 -s=8  > main/Display/fonts/data/font_X11misc_5x8.h
# python /home/viordash/projects/SuPLC/linux_app/main/Display/fonts/tools/create_font.py -f "/usr/share/fonts/X11/misc/clR5x10.pcf.gz" -n "X11Misc" -c="ISO8859-1" -ttf=1 --first=32 --last=127 -s=10  > main/Display/fonts/data/font_X11misc_5x10.h